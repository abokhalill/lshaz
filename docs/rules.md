...
lshaz ships 15 rules, each targeting a specific microarchitectural hazard class. Every rule must map to a concrete hardware mechanism — cache, coherence, store buffer, TLB, branch predictor, NUMA, or allocator.
